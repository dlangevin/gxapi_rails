...
Moona interfaces with Google Analytics Experiments to retrieve data from 
...
Moona uses +#{Rails.root}/config/moona.yml+ to configure variables.  You can
